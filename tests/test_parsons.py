...
def test_find_max():
    from exercises.parsons import find_max
...
@pytest.mark.skip('Not implemented yet.')
def test_odd_list():
    from exercises.parsons import odd_list
...
def test_running_total():
    from exercises.parsons import running_total
...
def test_merge_sorted_lists():
    from exercises.parsons import merge_sorted_lists
